<template>
  ...
  >
    ...
    <div class="form-group">
      ...
      <div class="directory-hint">应用的根目录，包含主要代码文件</div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="directory-input">
        <input
          ...
          readonly
        />
        <button class="browse-button" @click="browsePath('modelDir')">
          浏览...
        </button>
      </div>
      <div class="directory-hint">存放模型文件的目录，相对于工作目录</div>
    ...
    <div class="form-group">
      ...
      <div class="directory-input">
        <input
          ...
          readonly
        />
        <button class="browse-button" @click="browsePath('outputDir')">
          浏览...
        </button>
      </div>
      <div class="directory-hint">存放生成内容的目录，相对于工作目录</div>
      <div class="directory-suggestion">
        <div class="suggestion-title">建议路径:</div>
        <div class="suggestion-paths">
          <div
